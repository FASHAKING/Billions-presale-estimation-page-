    ...
    <section id="calculator" className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 flex flex-col gap-5">
          ...
          {selectedOption === 'A' ? (
            /* Option A — refund */
            <div className="glass-card p-8 flex flex-col items-center justify-center min-h-[220px] text-center gap-4 border-gray-500/25">
              <BadgeDollarSign size={40} className="text-gray-400" />
              <div>
                <h3 className="text-xl font-bold text-white mb-2">Full Refund</h3>
                <p className="text-gray-400 text-sm max-w-xs">
                  You receive 100% of your original contribution back.
                  No $BILL tokens are allocated.
                </p>
              </div>
              {investmentNum > 0 && (
                <div className="bg-gray-700/20 border border-gray-600/30 rounded-xl px-6 py-3">
                  <span className="text-2xl font-black text-white">{usd(investmentNum)}</span>
                  <p className="text-xs text-gray-500 mt-1">refunded to your wallet</p>
                </div>
              )}
            </div>
          ) : !hasResult ? (
