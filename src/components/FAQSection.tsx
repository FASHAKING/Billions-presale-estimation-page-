...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Option A gives you a full 100% refund of your original contribution plus a 5% cash bonus on top — no tokens. Refunds begin ~May 19, 2026 and may take up to 3–4 weeks after TGE to fully process. Option B lets you keep your full token allocation plus a 25% bonus in tokens, with a 6-month lock after TGE. Option C gives you a 50% token bonus on top of your full allocation, locked for 12 months after TGE. B and C are designed for contributors who want longer-term alignment with Billions.',
  },
  {
